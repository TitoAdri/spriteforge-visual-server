...
export const manualEditorMarkup = ({ assets = [], assetId = "" } = {}) => `<section class="studio-view manual-editor-view" data-manual-editor data-asset-id="${escapeHtml(assetId)}">
  ...
  <div class="manual-editor-stage" data-editor-stage><div class="manual-editor-loading" data-editor-loading><span></span><b>${assetId ? "Loading your editable asset…" : "Choose an asset to start editing"}</b></div><iframe data-editor-frame src="/pixel-editor/index.html?v=18" title="SpriteForge pixel art editor"></iframe></div>
