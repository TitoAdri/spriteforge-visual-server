...
render();
  ...
  root.querySelector("#asset-edit").insertAdjacentHTML("afterend", '<button id="asset-view-app" type="button">View in app</button><button id="asset-animate" type="button">Animate</button>');
